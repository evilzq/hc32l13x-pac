...
#[doc = "Field `ERRCLR` writer - desc ERRCLR"]
pub type ERRCLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICLR_SPEC, bool, O>;
impl W {
    #[doc = "Bit 0 - desc ERRCLR"]
    #[inline(always)]
...
#[doc = "`reset()` method sets ICLR to value 0x01"]
