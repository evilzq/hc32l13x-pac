...
#[doc = "Register `PCDR` writer"]
pub struct W(crate::W<PCDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PCDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PCDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PCDR_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "`write(|w| ..)` method takes [pcdr::W](W) writer structure"]
impl crate::Writable for PCDR_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PCDR to value 0xffff_ffff"]
