#[doc = "Register `PA_STAT` reader"]
pub struct R(crate::R<PA_STAT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PA_STAT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PA_STAT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PA_STAT_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "desc PA_STAT\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pa_stat](index.html) module"]
pub struct PA_STAT_SPEC;
impl crate::RegisterSpec for PA_STAT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pa_stat::R](R) reader structure"]
impl crate::Readable for PA_STAT_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PA_STAT to value 0"]
impl crate::Resettable for PA_STAT_SPEC {
    #[inline(always)]
