...
#[doc = "Field `CMA1E` reader - desc CMA1E"]
pub type CMA1E_R = crate::BitReader<bool>;
#[doc = "Field `CMA1E` writer - desc CMA1E"]
pub type CMA1E_W<'a, const O: u8> = crate::BitWriter<'a, u32, ADTR_SPEC, bool, O>;
#[doc = "Field `CMA2E` reader - desc CMA2E"]
pub type CMA2E_R = crate::BitReader<bool>;
#[doc = "Field `CMA2E` writer - desc CMA2E"]
pub type CMA2E_W<'a, const O: u8> = crate::BitWriter<'a, u32, ADTR_SPEC, bool, O>;
...
#[doc = "Field `CMB1E` reader - desc CMB1E"]
pub type CMB1E_R = crate::BitReader<bool>;
#[doc = "Field `CMB1E` writer - desc CMB1E"]
pub type CMB1E_W<'a, const O: u8> = crate::BitWriter<'a, u32, ADTR_SPEC, bool, O>;
#[doc = "Field `CMB2E` reader - desc CMB2E"]
pub type CMB2E_R = crate::BitReader<bool>;
#[doc = "Field `CMB2E` writer - desc CMB2E"]
pub type CMB2E_W<'a, const O: u8> = crate::BitWriter<'a, u32, ADTR_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 2 - desc CMA1E"]
    #[inline(always)]
    pub fn cma1e(&self) -> CMA1E_R {
        CMA1E_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - desc CMA2E"]
    #[inline(always)]
    pub fn cma2e(&self) -> CMA2E_R {
        CMA2E_R::new(((self.bits >> 3) & 1) != 0)
    }
    ...
    #[doc = "Bit 5 - desc CMB1E"]
    #[inline(always)]
    pub fn cmb1e(&self) -> CMB1E_R {
        CMB1E_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - desc CMB2E"]
    #[inline(always)]
    pub fn cmb2e(&self) -> CMB2E_R {
        CMB2E_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - desc ADTE"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 2 - desc CMA1E"]
    #[inline(always)]
    pub fn cma1e(&mut self) -> CMA1E_W<2> {
        CMA1E_W::new(self)
    }
    #[doc = "Bit 3 - desc CMA2E"]
    #[inline(always)]
    pub fn cma2e(&mut self) -> CMA2E_W<3> {
        CMA2E_W::new(self)
    }
    #[doc = "Bit 4 - desc CMB0E"]
    #[inline(always)]
    ...
    #[doc = "Bit 5 - desc CMB1E"]
    #[inline(always)]
    pub fn cmb1e(&mut self) -> CMB1E_W<5> {
        CMB1E_W::new(self)
    }
    #[doc = "Bit 6 - desc CMB2E"]
    #[inline(always)]
    pub fn cmb2e(&mut self) -> CMB2E_W<6> {
        CMB2E_W::new(self)
    }
    #[doc = "Bit 7 - desc ADTE"]
    #[inline(always)]
