...
pub type CLKSRC_W<'a, const O: u8> = crate::BitWriter<'a, u32, CR1_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 10 - desc DMAEN"]
    #[inline(always)]
    pub fn dmaen(&self) -> DMAEN_R {
        DMAEN_R::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - desc INTF"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 7 - desc CLKSRC"]
    #[inline(always)]
    pub fn clksrc(&mut self) -> CLKSRC_W<7> {
        CLKSRC_W::new(self)
    }
    #[doc = "Bit 8 - desc MODE"]
    #[inline(always)]
