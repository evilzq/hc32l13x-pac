...
pub type INTF_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTCLR_SPEC, bool, O>;
#[doc = "Field `RSV` writer - desc RSV"]
pub type RSV_W<'a, const O: u8> = crate::BitWriter<'a, u32, INTCLR_SPEC, bool, O>;
impl W {
    #[doc = "Bit 10 - desc INTF"]
    #[inline(always)]
    pub fn intf(&mut self) -> INTF_W<10> {
        INTF_W::new(self)
    }
    #[doc = "Bit 31 - desc RSV"]
    #[inline(always)]
